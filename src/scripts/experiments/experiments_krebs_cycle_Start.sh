...
# ${CMD} problem="krebs_cycle_normalised_1" paths.data_root="/Users/xiaoyuhe/Causal-Methods/krebcycle/data" solver="notebook_all" solver.skip_existing=false

# Run Krebs_Cycle_3_Normalised
${CMD} problem="krebs_cycle_normalised_3" paths.data_root="/Users/xiaoyuhe/Causal-Methods/krebcycle/data" solver="notebook_all" solver.skip_existing=false
